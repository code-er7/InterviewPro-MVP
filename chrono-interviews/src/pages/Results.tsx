        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <Card className="shadow-card">
            <CardHeader>
              ...
              <CardDescription>
                Comprehensive evaluation based on technical skills and communication
              </CardDescription>
            </CardHeader>
          ...
          <Card className="shadow-card">
            ...
            <CardContent className="space-y-4">
              <div className="flex items-center justify-between p-3 rounded-lg border">
                <div>
                  <h4 className="font-medium text-foreground">React Fundamentals</h4>
                  <p className="text-sm text-muted-foreground">5 questions asked</p>
                </div>
              ...
              <div className="flex items-center justify-between p-3 rounded-lg border">
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">3 questions asked</p>
                </div>
                <div className="flex items-center gap-2">
                  <CheckCircle className="h-4 w-4 text-green-500" />
              ...
              <div className="flex items-center justify-between p-3 rounded-lg border">
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">2 coding challenges</p>
                </div>
                <div className="flex items-center gap-2">
              ...
              <div className="flex items-center justify-between p-3 rounded-lg border">
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">1 design question</p>
                </div>
                <div className="flex items-center gap-2">
                  <CheckCircle className="h-4 w-4 text-green-500" />
          ...
          <Card className="shadow-card lg:col-span-2">
            ...
            <CardContent className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  ...
                  <ul className="space-y-2 text-sm text-muted-foreground">
                    <li>• Strong technical knowledge in React and TypeScript</li>
              ...
              <div className="border-t pt-6">
                <h4 className="font-semibold text-foreground mb-3">Interview Metrics</h4>
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-center">
                  <div>
                    <div className="text-2xl font-bold text-primary">45</div>
                    <div className="text-xs text-muted-foreground">Minutes Duration</div>
                  </div>
                  <div>
                  ...
                  <div>
                    ...
                    <div className="text-xs text-muted-foreground">Code Challenges</div>
                  </div>
                </div>
              </div>
            </CardContent>
